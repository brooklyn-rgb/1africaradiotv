...
<div className="w-full">
  <div className="h-2 bg-red-500"></div>
	<div className="flex items-center justify-center relative bg-[url('/music.gif')] bg-no-repeat bg-cover bg-opacity-60">
		<div className="bg-[url('/music.gif')] bg-no-repeat bg-cover shadow-lg rounded-lg w-250 h-130">
			<div className="flex">
				<div>
					<img className="w-full rounded hidden md:block bg-opacity-50" src="/logo.jpg" alt="Album Pic"/>
				</div>
				<div className="w-full p-8">
					<div className="flex justify-between">
						<div>
							<h3 className="text-2xl text-[#a2790d] font-bold">1AfricaRadioTV Live</h3>
							<p className="text-sm text-[#a2790d] font-semibold mt-1">Live Broadcast</p>
						</div>
