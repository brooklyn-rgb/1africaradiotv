...
<div className="2xl:mx-auto 2xl:container mx-4 py-16">
  ...
  <div className="w-full relative flex items-center justify-center">
    <img src="/images/collen.jpg" alt="dining" className="w-full h-full absolute z-0 hidden xl:block" />
    <img src="/images/collen.jpg" alt="dining" className="w-full h-full absolute z-0 hidden sm:block xl:hidden" />
    <img src="/images/collen.jpg" alt="dining" className="w-full h-full absolute z-0 sm:hidden" />
    <div className="bg-gray-800 bg-opacity-80 md:my-16 lg:py-16 py-10 w-full md:mx-24 md:px-12 px-4 flex flex-col items-center justify-center relative z-40">
      ...
      <p className="text-base leading-normal text-center text-white mt-6">
        Subscribe to our newsletter to stay in the loop. Our newsletter is sent once in <br />
